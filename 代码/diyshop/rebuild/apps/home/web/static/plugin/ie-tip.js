$(function () {
	...
	var $div = $('<div id="showDiv"><span style="float:left; margin:7px 10px;"><img src="' + img1 + '"/></span><span style="float:left; line-height:33px;">检测到您的浏览器版本过低，为了使您获得更好的优满分体验，请升级最新IE浏览器或使用谷歌Chrome浏览器。</span><span style="float:right; cursor:pointer; margin: 5px 10px;"><img id="close" src="' + img2 + '" width="17" height="17"/></span><div style="clear:both;"></div></div>').css({
		"margin": 0,
		"color": "#666",
		"width": "100%",
		"background": "#efe",
